...
<body>
  ...
  <!-- NAVIGATION -->
    <header class="header">
        ...
        <nav class="nav-menu">
            <ul class="nav-list">
                <li class="nav-item"><a href="login.jsp" class="nav-link">Home</a></li>
                <li class="nav-item"><a href="login.jsp" class="nav-link">Taxi</a></li>
                <li class="nav-item"><a href="login.jsp" class="nav-link">Book a Taxi</a></li>
                <li class="nav-item"><a href="login.jsp" class="nav-link">Contact Us</a></li>
                <li class="nav-item"><a href="login.jsp" class="nav-link">About Us</a></li>
            </ul>
        </nav>
        <ul class="nav-list right">
            <li class="nav-btn"><a href="login.jsp" class="nav-linker login-btn">Login</a></li>
            <li class="nav-btn"><a href="signup.jsp" class="nav-linker signup-btn">Sign Up</a></li>
        </ul>
    </header>
        ...
        <div class="hero-slide">
            <div class="owl-carousel carousel-nav-center" id="hero-carousel">
                <div class="hero-slide-item">
                    <img src="https://www.carfinance247.co.uk/dA/3a4aa2e81864e60428530c062abf9595/asset/Taxi%20driver%20car%20finance.jpg" alt="Taxi">
                    <div class="overlay"></div>
                    <div class="hero-slide-item-content">
                        <div class="item-content-wraper">
                            <div class="item-content-title top-down">Book Your Ride Now</div>
                            <div class="ride-infos top-down delay-2">
                                <div class="ride-info"><i class="bx bxs-car"></i><span>Fast & Reliable</span></div>
                                <div class="ride-info"><i class="bx bxs-map"></i><span>Anywhere, Anytime</span></div>
                                <div class="ride-info"><i class="bx bxs-wallet"></i><span>Affordable Prices</span></div>
                                <div class="ride-info"><i class="bx bxs-lock"></i><span>Safe & Secure</span></div>
                            </div>
                            <div class="item-action top-down delay-6">
                                <a href="book-taxi.html" class="btn btn-hover"><i class="bx bxs-right-arrow"></i><span>Book Now</span></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="taxis-slide carousel-nav-center owl-carousel">
                <a href="book-taxi.html" class="taxi-item">
